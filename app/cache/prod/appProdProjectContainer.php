...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\solicitudMonitoria\\EstudianteBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\solicitudMonitoria\\SeguridadBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\solicitudMonitoria\\CursosBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\solicitudMonitoria\\JefeSeccionBundle\\Entity')));
        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'solicitudMonitoria\\EstudianteBundle\\Entity');
        $c->addDriver($b, 'solicitudMonitoria\\SeguridadBundle\\Entity');
        $c->addDriver($b, 'solicitudMonitoria\\CursosBundle\\Entity');
        $c->addDriver($b, 'solicitudMonitoria\\JefeSeccionBundle\\Entity');
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('solicitudMonitoriaEstudianteBundle' => 'solicitudMonitoria\\EstudianteBundle\\Entity', 'solicitudMonitoriaSeguridadBundle' => 'solicitudMonitoria\\SeguridadBundle\\Entity', 'solicitudMonitoriaCursosBundle' => 'solicitudMonitoria\\CursosBundle\\Entity', 'solicitudMonitoriaJefeSeccionBundle' => 'solicitudMonitoria\\JefeSeccionBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0a84a067a1e5e5d36d31a2f71cefced4bc851b55d972c459881029eafbba9fd6');
        return $instance;
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'solicitudMonitoria\\SeguridadBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/dirDepartamento');
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/jefeSeccion');
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/estudiante');
        $j = new \Symfony\Component\Security\Http\AccessMap();
        $j->add($g, array(0 => 'ROLE_DIRECTOR'), NULL);
        $j->add($h, array(0 => 'ROLE_JEFESECCION'), NULL);
        $j->add($i, array(0 => 'ROLE_ESTUDIANTE'), NULL);
        $k = new \Symfony\Component\Security\Core\User\InMemoryUserProvider();
        $k->createUser(new \Symfony\Component\Security\Core\User\User('director', 'pass', array(0 => 'ROLE_DIRECTOR')));
        $k->createUser(new \Symfony\Component\Security\Core\User\User('jefeSeccion', 'pass', array(0 => 'ROLE_JEFESECCION')));
        $k->createUser(new \Symfony\Component\Security\Core\User\User('estudiante', 'pass', array(0 => 'ROLE_ESTUDIANTE')));
        ...
        $n->setOptions(array('login_path' => '/login', 'default_target_path' => 'solicitud_monitoria_seguridad_index', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.administrators'), 1 => $k), 'secured_area', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $l, 'secured_area', $n, $o, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54c902ce2ea48', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\solicitudMonitoria\\EstudianteBundle/Resources/views'), 'solicitudMonitoriaEstudiante');
        $instance->addPath(($this->targetDirs[3].'\\src\\solicitudMonitoria\\SeguridadBundle/Resources/views'), 'solicitudMonitoriaSeguridad');
        $instance->addPath(($this->targetDirs[3].'\\src\\solicitudMonitoria\\CursosBundle/Resources/views'), 'solicitudMonitoriaCursos');
        $instance->addPath(($this->targetDirs[3].'\\src\\solicitudMonitoria\\JefeSeccionBundle/Resources/views'), 'solicitudMonitoriaJefeSeccion');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c7f1f1662ad048abe8de3ea5ba65adbd3e4559e0');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.administrators'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'solicitudMonitoriaSeguridadBundle:Usuario', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'solicitudMonitoriaEstudianteBundle' => 'solicitudMonitoria\\EstudianteBundle\\solicitudMonitoriaEstudianteBundle',
                'solicitudMonitoriaSeguridadBundle' => 'solicitudMonitoria\\SeguridadBundle\\solicitudMonitoriaSeguridadBundle',
                'solicitudMonitoriaCursosBundle' => 'solicitudMonitoria\\CursosBundle\\solicitudMonitoriaCursosBundle',
                'solicitudMonitoriaJefeSeccionBundle' => 'solicitudMonitoria\\JefeSeccionBundle\\solicitudMonitoriaJefeSeccionBundle',
            ),
            ...
            'locale' => 'en',
            'secret' => 'c7f1f1662ad048abe8de3ea5ba65adbd3e4559e0',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'c7f1f1662ad048abe8de3ea5ba65adbd3e4559e0',
