...
namespace Proxies\__CG__\solicitudMonitoria\SeguridadBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Usuario extends \solicitudMonitoria\SeguridadBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'solicitudMonitoria\\SeguridadBundle\\Entity\\Usuario' . "\0" . 'idEstudiante', '' . "\0" . 'solicitudMonitoria\\SeguridadBundle\\Entity\\Usuario' . "\0" . 'username', '' . "\0" . 'solicitudMonitoria\\SeguridadBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'solicitudMonitoria\\SeguridadBundle\\Entity\\Usuario' . "\0" . 'roles', '' . "\0" . 'solicitudMonitoria\\SeguridadBundle\\Entity\\Usuario' . "\0" . 'isActive', '' . "\0" . 'solicitudMonitoria\\SeguridadBundle\\Entity\\Usuario' . "\0" . 'salt');
        }
