...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["estudiantesolicitudes"]) ? $context["estudiantesolicitudes"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["estudiantesolicitud"]) {
            // line 17
            echo "\t\t\t\t";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["estudiantemonitorias"]) ? $context["estudiantemonitorias"] : null));
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["estudiantemonitoria"]) {
            ...
            if (($this->getAttribute($context["estudiantemonitoria"], "CantidadMonitorias", array()) != 0)) {
                ...
                // line 63
                echo "                    ";
                if (((isset($context["esta"]) ? $context["esta"] : null) == "no")) {
                    // line 64
                    echo "                        ";
                    $context["hay"] = "si";
                    // line 65
